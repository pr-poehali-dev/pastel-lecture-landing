...
const lectures = [
  {
    ...
    description: "Погрузитесь в удивительный мир квантовой физики, изучая фундаментальные принципы и концепции, которые лежат в основе современной науки.",
  },
  {
    id: 2,
    ...
    description: "Курс посвящен изучению дифференциальных уравнений, их классификации, методам решения и практическому применению в различных областях науки.",
  },
  {
    id: 3,
    title: "Органическая химия",
    category: "Химия",
    image: "https://images.unsplash.com/photo-1603126857599-f6e157fa2fe6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    duration: 55,
    level: "Начальный",
    instructor: "Дмитрий Петров",
    description: "Введение в органическую химию: изучение структуры, свойств и реакций органических соединений, которые составляют основу живой материи.",
  },
  {
    id: 4,
    title: "Клеточная биология",
    category: "Биология",
    image: "https://images.unsplash.com/photo-1530026405186-ed1f139313f8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    duration: 50,
    level: "Средний",
    instructor: "Елена Сидорова",
    description: "Детальное изучение клетки — структурной и функциональной единицы всех живых организмов, ее органелл и процессов жизнедеятельности.",
  },
  {
    id: 5,
    ...
    description: "Курс по эффективным алгоритмам и структурам данных, необходимым для разработки оптимизированного программного обеспечения.",
  },
  {
    id: 6,
    ...
    description: "Обзор принципов функционирования мировой экономики, международных экономических отношений и глобальных экономических проблем.",
  },
];
        ...
        >
          <Card 
            className={`overflow-hidden cursor-pointer transition-all duration-300 h-full ${
              expandedLecture === lecture.id ? "shadow-xl" : "shadow-md hover:shadow-lg"
            }`}
              ...
              <div className={`${
                ...
                <div className={`p-5 flex flex-col ${
                  ...
                  <div className={`flex justify-end mt-auto ${
                    ...
                    >
                      {expandedLecture === lecture.id ? (
                        <>Свернуть <Icon name="ChevronUp" className="ml-1 w-5 h-5" /></>
                      ) : (
                        <>Подробнее <Icon name="ChevronRight" className="ml-1 w-5 h-5" /></>
                      )}
                    </motion.div>
                  </div>
                </div>
